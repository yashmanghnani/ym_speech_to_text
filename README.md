...
[![pub package](https://img.shields.io/badge/pub-v7.3.0-blue)](https://pub.dartlang.org/packages/ym_speech_to_text)
...
```dart
import 'package:ym_speech_to_text/speech_to_text.dart' as stt;
...
import 'package:ym_speech_to_text/speech_recognition_result.dart';
...
#### Basic example ([example/lib/main.dart](https://github.com/yashmanghnani/ym_speech_to_text/blob/main/speech_to_text/example/lib/main.dart))
...
#### Provide example ([example/lib/provider_example.dart](https://github.com/yashmanghnani/ym_speech_to_text/blob/main/speech_to_text/example/lib/provider_example.dart))
...
#### Plugin stress test ([example/lib/stress.dart](https://github.com/yashmanghnani/ym_speech_to_text/blob/main/speech_to_text/example/lib/stress.dart))
...
#### Audio player interaction ([examples/audio_player_interaction/lib/main.dart](https://github.com/yashmanghnani/ym_speech_to_text/blob/main/examples/audio_player_interaction/lib/main.dart))
...
see: https://github.com/yashmanghnani/ym_speech_to_text/issues/ for details._
...
it requires a flag to be set on initialization. You can see the details in this [issue](https://github.com/yashmanghnani/ym_speech_to_text/issues/)
...
[issue](https://github.com/yashmanghnani/ym_speech_to_text/issues/) has some details.
...
another sound plugin and starting to listen using SpeechToText. See this [issue](https://github.com/yashmanghnani/ym_speech_to_text/issues/)
for example.
...
This happens when the Swift language version is not set correctly. See this thread for help https://github.com/yashmanghnani/ym_speech_to_text/issues/.
...
This usually happens for older projects that only support Objective-C. See this thread for help https://github.com/yashmanghnani/ym_speech_to_text/issues/.

### Last word lost on Android

There's a discussion here https://github.com/yashmanghnani/ym_speech_to_text/issues/ about this known issue
...
in the Android log. There's a lengthy issue discussion here https://github.com/yashmanghnani/ym_speech_to_text/issues/
...
From issue [#298](https://github.com/yashmanghnani/ym_speech_to_text/issues/) this is the detailed set of steps that
